...
func (a *FeeActivities) CalculateFee(ctx context.Context, tenantID, txType, currency string, amount int64) (*walletfees.FeeResult, error) {
	if a == nil || a.Store == nil {
		return nil, ErrMissingStore
	}
	engine := walletfees.FeeEngine{Store: a.Store}
	return engine.Calculate(ctx, tenantID, txType, currency, amount)
}
