...
func walletAuthorityGrants() []string {
	return []string{
		...
		`GRANT SELECT ON TABLE public.currencies, public.currency_unit_versions, public.fx_sources, public.fx_source_pairs, public.fx_source_pair_sides, public.fx_observations, public.money_conversion_quotes TO wallet_ledger_worker`,
		`GRANT INSERT ON TABLE public.fx_observations TO wallet_ledger_worker`,
		...
		`GRANT SELECT ON TABLE public.psp_configs, public.psp_config_overrides, public.psp_amount_policies TO wallet_ledger_runtime`,
		...
		`GRANT SELECT ON TABLE public.psp_configs, public.psp_config_overrides, public.psp_amount_policies TO wallet_ledger_worker`,
