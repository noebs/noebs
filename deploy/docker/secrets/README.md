...
That renderer uses the Kubernetes preflight layout (`config.yaml`, `services/`, `secrets/`, `.sops/age-key.txt`, and `platform/`) instead of the Docker Compose release layout.
