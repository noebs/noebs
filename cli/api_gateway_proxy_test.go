...
func TestAPIGatewayCatalogIsExactOIDCCutoverSurface(t *testing.T) {
	expected := map[string]gatewayAuthMode{
		...
		gatewayRouteKey(http.MethodPost, "/consumer/identity/sessions"):                               gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodGet, "/consumer/identity/verification"):                            gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodGet, "/consumer/identity/sessions/latest"):                         gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodGet, "/consumer/identity/sessions/:session_id"):                    gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodPut, "/consumer/identity/sessions/:session_id/evidence/:kind"):     gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodPost, "/consumer/identity/sessions/:session_id/submit"):            gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodPost, "/consumer/identity/sessions/:session_id/withdraw"):          gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodDelete, "/consumer/identity/sessions/:session_id"):                 gatewayAuthMobileUser,
		...
		gatewayRouteKey(http.MethodGet, "/consumer/status-notifications"):                             gatewayAuthMobileUser,
		...
		gatewayRouteKey(http.MethodGet, "/wallet/me"):                                                 gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodGet, "/wallet/providers"):                                          gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodGet, "/wallet/funding-methods"):                                    gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodGet, "/wallet/methods"):                                            gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodGet, "/wallet/currencies"):                                         gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodGet, "/wallet/currencies/:code"):                                   gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodPost, "/wallet/money/parse"):                                       gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodPost, "/wallet/money/format"):                                      gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodPost, "/wallet/fx/quotes"):                                         gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodGet, "/wallet/fx/quotes/:id"):                                      gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodGet, "/wallet/fx/sources"):                                         gatewayAuthMobileUser,
		...
		gatewayRouteKey(http.MethodPost, "/wallet/p2p/preview"):                                       gatewayAuthMobileUser,
		gatewayRouteKey(http.MethodGet, "/wallet/p2p/status"):                                         gatewayAuthMobileUser,
