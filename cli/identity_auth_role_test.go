...
func identityAuthActiveRoutes() []gatewayRouteExpectation {
	return []gatewayRouteExpectation{
		...
		{method: http.MethodPost, path: "/consumer/identity/sessions/:session_id/withdraw", auth: gatewayAuthMobileUser},
		{method: http.MethodDelete, path: "/consumer/identity/sessions/:session_id", auth: gatewayAuthMobileUser},
