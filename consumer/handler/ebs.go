...
func (h *Handler) IsAlive(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerIsAliveFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) BillInquiry(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerBillInquiryFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) Balance(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerBalanceFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) TransactionStatus(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerTransactionStatusFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) WorkingKey(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerWorkingKeyFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) CashIn(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerCashInFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) CashOut(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerCashoOutFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) AccountTransfer(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumrAccountTransferFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) IPinChange(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerIPinFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) Status(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerStatusFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) QRMerchantRegistration(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerQRRegistration) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) QRPayment(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerQRPaymentFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) QRRefund(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerQRRefundFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) QRComplete(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerQRCompleteFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) QRTransactions(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerQRStatus) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) EbsGetCardInfo(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerCardInfoFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) RegisterCard(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerRegistrationFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) CardTransfer(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerCardTransferAndMobileFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
...
func (h *Handler) MobileTransfer(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerMobileTransferFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
		r.DynamicFees = h.Service.NoebsConfig.EBSDynamicFees.CardTransferfees
...
func (h *Handler) GenerateVoucher(c *fiber.Ctx) error {
	...
	return handleConfiguredEBS(h, c, &req, func(r *ebs_fields.ConsumerGenerateVoucherFields) {
		r.ApplicationId = h.Service.NoebsConfig.ConsumerID
